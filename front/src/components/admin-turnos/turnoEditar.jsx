  ...
  const handleChange = (e) => {
    ...
    if (name === "nombre") {
      if (!value || /^\s+$/.test(value)) {
        ...
        setError((prevError) => ({
          ...prevError,
          nombre: "El formato del nombre no es válido",
        }));
      } else {
    ...
    if (name === "horaFin") {
      ...
      if (horaInicioValue && value && value < horaInicioValue) {
        ...
        setError((prevError) => ({
          ...prevError,
          horaFin: "La hora de inicio y la hora de fin no pueden ser iguales",
        }));
      } else {
      ...
      <div className="formContainer">
        ...
        <form className="formulario" onSubmit={handleSubmit}>
          ...
          <div className="myform-group">
            ...
            />
            {error.horaInicio && (
              <div className="error">{error.horaInicio}</div>
            )}
          </div>
          ...
          <div>
            ...
            {diasOptions.map((option) => (
              <div key={option.value}>
                ...
                />
                <label className="myLabel" htmlFor={option.value}>
                  {option.label}
                </label>
              </div>
            ))}
