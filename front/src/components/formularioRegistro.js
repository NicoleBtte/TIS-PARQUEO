      ...
      <Formik
            ...
            validate={(values) => {
				...
				if(!values.direccion){
					...
					errors.direccion = 'La dirección solo puede contener letras, espacios, dígitos, espacios, guiones, almohadillas y puntos.'
				}
            ...
            <Form className='formulario'>
                ...
                <div>
					...
					<Field
						...
						name="placa" 
					/>
					<ErrorMessage name="placa" component={() => (<div className="error">{errors.placa}</div>)} />
				</div>
                <div>
                ...
                <div>
					...
					<Field
						...
						name="ccontrasena" 
					/>
					<ErrorMessage name="ccontrasena" component={() => (<div className="error">{errors.ccontrasena}</div>)} />
				</div>
